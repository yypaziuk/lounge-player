...
- **18 themes** that can auto-change by time of day
  ...
  - **Full version (11):** Monsoon Rain · Cozy Library · Cognac & Oak · Nebula Dream · Sakura Dawn · Synthwave · Abyssal Ocean · Noir Velvet · Sunset Drift · First Light · Jade Hour
...
- Export / Import your station collection as JSON (full version: backup of everything)
...
The **full** edition (`pro.html`) is **also free to use**, but its source is not open and it is not
